...
# Feature extraction: available features and functions to apply (feel free to add your own features)
FEATURE_FUNCS = {
...
# Selected feature subsets for unsupervised clustering (feel free to add your own pre-sets)
FEATURE_SETS = {
    'set_basic': ['mean', 'median', 'std', 'percentile_5', 'percentile_10', 'percentile_25', 'percentile_33',
                  'percentile_66', 'percentile_75', 'percentile_90', 'percentile_95'],
    'set_change': ['std', 'rel_energy', 'rel_sum_of_changes', 'rel_number_peaks', 'rel_long_strike_below_mean',
                   'rel_long_strike_above_mean', 'rel_count_below_mean'],
    'set_ext': ['mean', 'median', 'std', 'percentile_5', 'percentile_10', 'percentile_25', 'percentile_33',
    ...
    'set_large': ['mean', 'median', 'std', 'percentile_5', 'percentile_10', 'percentile_25', 'percentile_33',
                  'percentile_66', 'percentile_75', 'percentile_90', 'percentile_95', 'rel_energy',
                  'rel_sum_of_changes', 'rel_number_crossing_0', 'rel_number_peaks', 'rel_long_strike_below_mean',
                  'rel_long_strike_above_mean', 'rel_count_below_mean', 'mean_abs_change', 'mean_change',
                  'mean_sec_derivative_central', 'skewness', 'kurtosis', 'first_location_of_maximum',
